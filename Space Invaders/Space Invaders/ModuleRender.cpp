...
bool ModuleRender::Draw(const SDL_Texture& texture, fPoint position, const SDL_Rect& section, float speed)
{
	bool ret = true;
	SDL_Rect rect;
	...
	{
		SDL_QueryTexture((SDL_Texture*)&texture, nullptr, nullptr, &rect.w, &rect.h);
	}

	if (SDL_RenderCopy(renderer, (SDL_Texture*)&texture, &section, &rect) != 0)
	{
