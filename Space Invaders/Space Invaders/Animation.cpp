...
Animation::Animation(int num_frames, float speed) : num_frames(num_frames), speed(speed)
{
	frames.reserve(this->num_frames);
}

Animation::Animation(int num_frames, int size, float speed) : num_frames(num_frames), speed(speed)
{
	frames.reserve(this->num_frames);
