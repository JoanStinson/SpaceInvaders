	...
	Entity(rect, rect_collider, texture, animation, texture_death, animation_death, position, life_points, damage, move_speed)
{
	...
	for (int i = 0; i < MAX_BULLETS; ++i)
		pooled_bullets.push_back(std::move(new Bullet({ 0, 0, 32, 32 }, { 8, 8, 16, 16 }, bullet_texture, bullet_texture_death, bullet_animation_death, fPoint(), 1, 1, -0.3f, this)));
...
void Enemy::PlayKillSound() const
{
